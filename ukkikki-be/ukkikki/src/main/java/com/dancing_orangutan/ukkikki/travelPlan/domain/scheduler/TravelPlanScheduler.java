package com.dancing_orangutan.ukkikki.travelPlan.domain.scheduler;
...
import com.dancing_orangutan.ukkikki.travelPlan.domain.scheduler.task.TravelPlanExpirationTask;
...
public class TravelPlanScheduler {
	...
	@EventListener
	public void expireTravelPlan(final TravelPlanCloseTimeChangedEvent event) {
