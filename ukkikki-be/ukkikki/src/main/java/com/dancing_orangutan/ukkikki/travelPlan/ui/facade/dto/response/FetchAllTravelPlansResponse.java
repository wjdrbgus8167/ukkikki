...
public record FetchAllTravelPlansResponse(
	...
	public static FetchAllTravelPlansResponse fromEntities(Page<TravelPlanEntity> pages) {

		List<TravelPlanResponse> travelPlans = pages.getContent().stream()
				.map(entity -> TravelPlanResponse.fromEntity(entity))
				.toList();

		return FetchAllTravelPlansResponse.
				builder()
