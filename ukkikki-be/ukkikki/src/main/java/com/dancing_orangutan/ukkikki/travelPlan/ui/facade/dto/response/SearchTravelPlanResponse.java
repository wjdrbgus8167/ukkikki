...
public record SearchTravelPlanResponse(List<TravelPlanResponse> travelPlans) {

	public static SearchTravelPlanResponse fromEntities(List<TravelPlanEntity> entities,
			Integer memberId) {
