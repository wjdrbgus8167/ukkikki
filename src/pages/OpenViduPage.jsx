                ...
                {this.state.session !== undefined ? (
                    <div id="session">
                        ...
                        <div id="video-container" className="col-md-6">
                            ...
                            {/* 일반 참가자 스트림 표시 (나 자신 포함) */}
                            {this.state.regularSubscribers
                                .filter((sub) => sub !== this.state.mainStreamManager) // mainStreamManager 제외
                                .map((sub, i) => (
                                    <StreamContainer
