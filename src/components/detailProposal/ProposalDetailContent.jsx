...
const ProposalDetailContent = () => {
  ...
  if (!proposal) return <p className="mt-10 text-center">로딩 중...</p>;
  ...
  const renderDaySchedule = (dayNumber) => {
    ...
    const daySchedule = proposal.companyDaySchedules.find(
      (schedule) => schedule.dayNumber === parseInt(dayNumber, 10)
    );
              ...
              {activeTab === '상세 내용' && (
                <div className="space-y-6">
                  ...
                  <div className="p-6 rounded-lg bg-gray-50">
                    <h3 className="mb-2 font-bold">탑승 및 도착 시간(datetime)</h3>
                    <br />
                    <div className="flex gap-24">
                      <div className="w-[280px]">
                        ...
                        <br />
                        <p>탑승 시간 : </p>
                        <p>{formatDateTime(proposal.startDateBoardingTime)}</p>
                        <br />
                        <p>도착 시간 :</p>
